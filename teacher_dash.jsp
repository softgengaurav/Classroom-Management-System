...
sql2="select count(*) from class where f_email="+mail+" group by f_email";
rs1=st.executeQuery(sql2);
rs1.next();
n=0;
n=Integer.parseInt(rs1.getString(1));
sql2="select * from class where f_email="+mail+"";
...
%>
                         <h5> <a href="class_dash_teacher.jsp?param=<%=courses[i] %>" ><%=courses[i] %> </a></h5>
                    </div>
                </div>
                <%
                }
