                     ...
                     <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <!-- <li><a class="menu-top-active" href="joinclass.jsp">Join Class</a></li>-->
                                           <button id="myBtn" class="button">Create Class</button>
  ...
  <div class="modal-content">
    ...
    <div class="modal-body" align="center">
      ...
      <form action="createclass.jsp" method="get">
        <input type="Class_Name"  name="classnamefield" class="button" required autocomplete="off"/>
...
String sql1="select * from teacher_db where f_email="+mail;
...
sql2="select count(*) from teacher_class where f_email="+mail+" group by f_email";
rs1=st.executeQuery(sql2);
rs1.next();
n=0;
n=Integer.parseInt(rs1.getString(1));
sql2="select * from teacher_class where f_email="+mail+"";
  ...
  <body>
    ...
    <script>
      function openColorBox(){
        $.colorbox({iframe:true, width:"40%", height:"40%", href: "message1.jsp"});
      }
            
      setTimeout(openColorBox, 200);
      setTimeout(function(){window.location.href='teacher_dash.jsp'},3000);
      </script>
  </body>
</html>
